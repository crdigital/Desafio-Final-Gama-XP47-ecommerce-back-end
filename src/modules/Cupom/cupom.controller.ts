...
class CupomController {
    ...
    public async update(req: Request, res: Response) {
        try {
            ...
            const cupom = await CupomModel.findByPk(id);
            ...
            const cupomUpdate = await CupomModel.update(payloadUpdate, {
                where: { id },
            });
    ...
    public async delete(req: Request, res: Response) {
        ...
        try {
            ...
            const cupomDelete = await CupomModel.destroy({
                where:{
                    id
                }
            });
    ...
    public async getAll(req: Request, res: Response) {
        try {
            ...
            const cuponsList = await CupomModel.findAll();
    ...
    public async getById(req: Request, res: Response) {
        try {
            ...
            const cupom = await CupomModel.findOne({
                where:{
                    id
                }
            });
